...
*/
double *calculateImportance(const nitro::CbdImage &img, bool cumulative, int num_layers) {
    ...
    int normFac = static_cast<int>(*std::max_element(importance, importance + 256));//find the max one.
    for (int i = 0; i < 256; ++i) {
