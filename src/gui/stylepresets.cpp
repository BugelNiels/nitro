...
nitro::StylePreset nitro::getDarkModePalette() {
    ...
    palette.setColor(QPalette::Base, QColor(29, 29, 32));               // Base color
    ...
    palette.setColor(QPalette::Disabled, QPalette::Base, QColor(31, 31, 34));
    palette.setColor(QPalette::Disabled, QPalette::AlternateBase, QColor(36, 36, 38));
    palette.setColor(QPalette::Disabled, QPalette::Window, QColor(42, 42, 48));
