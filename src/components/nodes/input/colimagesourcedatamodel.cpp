#include "colimagesourcedatamodel.hpp"
...
nitro::ColImageSourceDataModel::ColImageSourceDataModel()
        : _image(std::make_shared<ColImageData>()), _displayWrapper(nullptr), _loadButton{nullptr},
          _imgLabel(nullptr) {}

QJsonObject nitro::ColImageSourceDataModel::save() const {
...
void nitro::ColImageSourceDataModel::load(QJsonObject const &p) {
    // TODO: implemenet
...
unsigned int nitro::ColImageSourceDataModel::nPorts(QtNodes::PortType portType) const {
...
QtNodes::NodeDataType nitro::ColImageSourceDataModel::dataType(QtNodes::PortType, QtNodes::PortIndex) const {
    return ColImageData().type();
}

std::shared_ptr<QtNodes::NodeData> nitro::ColImageSourceDataModel::outData(QtNodes::PortIndex) {
    return _image;
}

QWidget *nitro::ColImageSourceDataModel::embeddedWidget() {
    if (!_displayWrapper) {
        ...
        connect(_loadButton, &QPushButton::pressed, this, &ColImageSourceDataModel::onLoadButtonPressed);
...
void nitro::ColImageSourceDataModel::onLoadButtonPressed() {
