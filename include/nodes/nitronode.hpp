...
/**
 * The nodes used by NITRO. These should only be constructed using the NitroNodeBuilder.
...
public:
    ...
    /**
     * Initialises this node with info.
    ...
    /**
     * Retrieves the caption of this node.
     * @return The caption of this node.
     */
    [[nodiscard]] QString caption() const override;

    /**
     * Retrieves whether or not the caption should be visible or not.
