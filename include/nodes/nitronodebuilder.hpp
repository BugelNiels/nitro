...
/**
 * Builder class that can be used to build new node types. All nodes should be constructed via this builder.
...
public:
    ...
    /**
     * Creates the node as configured.
     * @return A new node.
     */
    std::unique_ptr<NitroNode> build();

    /**
     * Adds an operator to the node. The operator is what is executed when a node is being evaluated.
    ...
    /**
     * Gives the node a specific color. Affects the icon color and caption background of a node.
    ...
    /**
     * Gives the node an icon. The icon path should be present in one of the resource files.
    ...
    /**
     * Gives the node an input port that takes inputs of type T.
    ...
    /**
     * Gives the node an input port that takes inputs of type T. The port, however, also accepts any data type with the id present in the allowedConversions list.
     * @see nitro::NodePorts#inputInteger
     * @see nitro::NodePorts#inputValue
     * @see nitro::NodePorts#inGet
     * @see nitro::NodePorts#inGetAs
    ...
    /**
     * Unique variation of withInputPort for integer types. Adds a slider widget to the node itself.
     * @see nitro::NodePorts#inputInteger
     * @see nitro::NodePorts#inGet
     * @see nitro::NodePorts#inGetAs
     * @see nitro::NodePorts#getInData
    ...
    /**
     * Unique variation of withInputPort for double types. Adds a slider widget to the node itself.
     * @see nitro::NodePorts#inputValue
     * @see nitro::NodePorts#inGet
     * @see nitro::NodePorts#inGetAs
     * @see nitro::NodePorts#getInData
    ...
    /**
     * Gives the node an output port that produces outputs of type T. Note that this type could be changed by the node operator if necessary.
    ...
    /**
     * Gives the node a load button to load a particular data type.
    ...
    /**
     * Adds an output port producing integers to the node.
    ...
    /**
     * Adds an output port producing doubles to the node.
    ...
    /**
     * Special port that produces a value not via the node operator by via a slider widget. Adds a slider widget to the node that produces integer values.
     * @param name The name of the port. Should be unique amongst the output ports, since this is used to put the corresponding data.
     * @param defaultVal The default value of the input port/slider.
    ...
    /**
     * Special port that produces a value not via the node operator by via a slider widget. Adds a slider widget to the node that produces double values.
     * @param name The name of the port. Should be unique amongst the output ports, since this is used to put the corresponding data.
     * @param defaultVal The default value of the input port/slider.
     * @param min The minimum value of the output port/slider.
     * @param max The maximum value of the output port/slider.
    ...
    /**
     * Adds a dropdown widget to the node.
    ...
    /**
     * Adds a checkbox widget to the node.
    ...
    /**
     * Adds a simple label to the node. Can be used to display images by adding a PixMap to the label.
    ...
    /**
     * Adds a simple label with the provided text to the node.
     * @param name The name of the label. Should be unique amongst the options, since this is used to put the corresponding data.
